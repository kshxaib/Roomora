export const getGoogleWelcomeEmailHtml = (name, password) => `
  ...
  ">
    ...
    <p style="margin-bottom: 20px; line-height: 1.6; color: #4b5563;">
      You've successfully created a Roomora account using Google authentication. 
    ...
    <p style="font-size: 12px; color: #9ca3af; text-align: center;">
      ...
      If you didn't request this account, please <a href="mailto:official.roomora@gmail.com" style="color: #3b82f6;">contact our security team</a> immediately.
    </p>
  </div>
`;